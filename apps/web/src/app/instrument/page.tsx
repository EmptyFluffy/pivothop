...
// The instrument at its own URL (2026-08-22: the homepage became a product
// landing; the tool moved here where it can rank for tool-intent queries and
// meet visitors who arrived wanting it). React owns the page; the tuned graph
// physics run as a vanilla module mounted imperatively (per the porting
// non-negotiables). The search bar is the front door:
...
export default function Instrument() {
  ...
  return (
    <PageShell v2 wide>
      ...
      {/* metadata (title/description/canonical) lives in layout.tsx — this
