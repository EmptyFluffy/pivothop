    ...
    <PageShell v2 active="employers">
      <div className="rtp">
        <nav className="rt-crumbs lbl" aria-label="Breadcrumb">
          ...
          <Link href="/employers">Employers</Link><span>/</span>
          <span>Hire in Costa Rica</span>
        </nav>
        <header className="rt-head">
          <p className="lbl acc">For employers</p>
          <h1 className="rt-h1">Hire remote talent in Costa Rica</h1>
          <p className="jb-lede">
            The pages that rank for this query quote &ldquo;directional&rdquo; salary ranges with no source.
          ...
          <p className="jb-vmeta">
            <span className="lbl">{m.total.toLocaleString()}</span> live CR openings &middot;{' '}
