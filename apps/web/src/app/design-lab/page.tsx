...
export default function LabIndex() {
  const items = [
    ...
    ['research', 'Research index', 'The blog as an editorial index, real registry.'],
    ['article', 'Article', 'The career change tax, real takeaways and FAQ.'],
    ['salary', 'Salary page', 'Architect, real percentiles and country bands.'],
