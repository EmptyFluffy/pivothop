...
const SOURCES = ['remotive', 'remoteok', 'greenhouse', 'lever', 'ashby', 'smartrecruiters', 'workable', 'recruitee', 'arbeitnow', 'jobicy', 'themuse', 'himalayas', 'getonbrd', 'careerjet', 'adzuna', 'usajobs', 'reed', 'jobroom', 'workday', 'direct'];
